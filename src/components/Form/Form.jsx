...
handleSubmit = event=>{
  ...
  this.props.onSubmit(newContact, filter);
...
<label htmlFor={this.numberId} className={css.label_number}>
  ...
  value={this.state.number} onChange={this.handleNumberChange} id={this.numberId}
  required
/></label>
<button className="button_submit" type="submit">Add contact</button>
</form>
            </div>
